...
% Here you should probably stress that the shape function is different from what it is usually defined as. The definition for a shape function is usually, "The minimum height given as a function of the width is called the shape function of the layout." So this makes it a "function."
