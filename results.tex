...
To proof if the Plantage produces better results for circuits without common centroids I have created two layouts, one with the basic line expansion router and one with the extended version. As it can be seen a far smaller distance between the modules is necessary. \nref{fig:miller_amplifier_smaller_routed_line_expansion_router}.

\begin{figure}
	\centering
	\subfloat[basic line expansion router]{\includegraphics[scale=0.6]{FIG/miller_amplifier_routed_smaller_basic_line_expansion.png}}
	\subfloat[extended line expansion router]{\includegraphics[scale=0.6]{FIG/miller_amplifier_routed_smaller_extended_line_expansion.png}}
